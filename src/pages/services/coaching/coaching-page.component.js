    ...
    return (
        <div>
            ...
            <div className="coachingPage-paragraph">
                <p>A pedagogical method in 4 steps to create a store that generates at least $4,000 per month in 6 weeks, without special skills, <span className='bold-text'>STARTING FROM 0 AND FROM HOME.</span></p>
            </div>
            <div  className="dropServices-cards">
                ...
                <Fade bottom>
                    <DropServicesCardsComponent
                        ...
                        description={<div>
                            After completing this module :   <br/> You have built an unshakeable e-merchant Mindset that gives you infinite resilience to
            ...
            <div>
                <div className="coachingPage">
                    <div className='coaching-textSection'>
                        ...
                        <p className='description'>Take advantage of our expertise and our marketing strategies to develop
                            your
                            business.</p>
                    </div>
                    <Zoom bottom>
