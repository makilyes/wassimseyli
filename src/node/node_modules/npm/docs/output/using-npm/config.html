...
<p>To make this default to <code>Infinity</code> instead of <code>null</code>, set <code>--all</code>.</p>
...
<p>[Deprecated] Install <code>dev-dependencies</code> along with packages.</p>
...
<li>Allow installing packages that have an <code>engines</code> declaration requiring a
different version of <code>node</code>, even if <code>--engines-strict</code> is enabled.</li>
...
packages.</p>
<h4 id="fetch-timeout">fetch-timeout</h4>
<ul>
...
<ul>
<li>Alias: <code>init.author.name</code></li>
<li>Default: “”</li>
<li>Type: String</li>
</ul>
...
<ul>
<li>Alias: <code>init.author.email</code></li>
<li>Default: “”</li>
<li>Type: String</li>
</ul>
...
<ul>
<li>Alias: <code>init.author.url</code></li>
<li>Default: “”</li>
<li>Type: String</li>
</ul>
...
<ul>
<li>Alias: <code>init.license</code></li>
<li>Default: “ISC”</li>
<li>Type: String</li>
</ul>
...
<ul>
<li>Alias: <code>init.version</code></li>
<li>Default: “1.0.0”</li>
<li>Type: semver</li>
</ul>
...
will be preferred.</p>
<h4 id="legacy-peer-deps">legacy-peer-deps</h4>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
...
<h4 id="strict-peer-deps">strict-peer-deps</h4>
<ul>
<li>Default: false</li>
<li>Type: Boolean</li>
</ul>
...
<p>By default, conflicting <code>peerDependencies</code> in the dependency graph will be
...
range set in their package’s <code>peerDependencies</code> object.  When such and
override is performed, a warning is printed, explaining the conflict and
the packages involved.  If <code>--strict-peer-deps</code> is set, then the warning is
